# Patchdoll Secure Agent Instructions (Claude Code)

These instructions are operator-controlled. Claude Code appends this file to its
own built-in behavior, and it takes precedence as a security and runtime
constraint. Workspace-level `CLAUDE.md` files may add project behavior and
